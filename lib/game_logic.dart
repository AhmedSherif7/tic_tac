...
class Game {
  ...
  Future<void> autoPlay(String activePlayer) async {
    ...
    // try to win - start / center (COLUMN) -
    ...
    // try to not lose - start / center (ROW) -
    ...
    // try to not lose - center / end (ROW) -
    ...
    // try to not lose - start / center (COLUMN) -
    ...
    // try to not lose - start / end (COLUMN) -
    ...
    // try to not lose - center / end (COLUMN) -
